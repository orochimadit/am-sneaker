...
export default function Menu() {
    ...
    return (
        <>
            <nav className="navbar navbar-dark bg-green shadow navbar-expand fixed-top p-2">
                <div className="container">
                    <ul className="navbar-nav nav-justified justify-content-center w-100">
                        <li className="nav-item">
                            <Link href="/" className="nav-link text-white fw-bold">
                                <svg width="1.2em" height="1.2em" viewBox="0 0 16 16" className="bi bi-house" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li className="nav-item dropup">
                            <Link href="/carts" className="nav-link text-white fw-bold">
                                <svg xmlns="http://www.w3.org/2000/svg" width="1.2em" height="1.2em" fill="currentColor" className="bi bi-cart" viewBox="0 0 16 16">
                        ...
                        <li className="nav-item dropup">
                            <Link href="/login" className="nav-link text-white fw-bold">
                                <svg xmlns="http://www.w3.org/2000/svg" width="1.2em" height="1.2em" fill="currentColor" className="bi bi-person-circle" viewBox="0 0 16 16">
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <div className="input-group">
                                <input type="text" className="form-control" onChange={searchHandler} placeholder="search product here..." />
                            </div>
                        </div>
